  ...
  return (
    <Container className="relative py-5 overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-10">
        ...
        <LinkButton className="w-44 flex items-center justify-center bg-white text-black hover:bg-black hover:text-white duration-200 mt-4">Start Shopping</LinkButton>
      </div>
    </Container>
  );
};
